...
citizen_kane = media.Movie("Citizen Kane",
                          "The story is a film that examines the life and legacy of Charles Foster Kane, played by Welles, a character based in part upon the American newspaper magnate William Randolph Hearst",
...
movies = [godfather_2, the_hours, citizen_kane, midnight_in_paris, schindlers_list, dr_strangeLove]
